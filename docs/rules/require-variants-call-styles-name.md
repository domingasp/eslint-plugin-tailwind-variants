...
- [Rule source](https://github.com/overpolish/eslint-plugin-tailwind-variants/blob/main/src/rules/require-variants-call-styles-name.js)
- [Test source](https://github.com/overpolish/eslint-plugin-tailwind-variants/blob/main/src/rules/require-variants-call-styles-name.test.js)
